  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-16 text-center space-y-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Company Locked</h1>

        <p className="text-gray-500">
          Your company account has been locked. You are unable to access the platform at this time.
        </p>
